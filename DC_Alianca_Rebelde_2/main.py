...
class GameManager:
    def __init__(self, root_tk):
        ...
        try:
            simbolo_path = os.path.join(self.script_dir, "alianca_simbolo.png") 
            if os.path.exists(simbolo_path): self.alianca_simbolo_photo = PhotoImage(file=simbolo_path)
            else: print(f"AVISO: Imagem 'alianca_simbolo.png' não encontrada.")
        except Exception as e_img:
            print(f"AVISO: Erro ao carregar alianca_simbolo.png: {e_img}")
    ...
    def update_display(self):
        ...
        if self.game_state == "INTRO_V2_A":
            ...
            self._display_text_screen("A Guerra Não Para", narrativa, "Continuar...", "INTRO_V2_B", button_style="Accent.Dark.TButton")
            ...
            self._display_text_screen("A Adaptação do Inimigo", narrativa, "Ouvir a transmissão...", "INTRO_V2_C", image_to_display=self.alianca_simbolo_photo)
            ...
            self._display_text_screen("Nova Doutrina: Dividir e Conquistar", narrativa, "Aceito o desafio, Fulcrum. Qual a primeira diretriz?", "YODA_INTRO_A", button_style="Accent.Dark.TButton", image_to_display=self.alianca_simbolo_photo)
            ...
            self._display_text_screen("Um Eco na Força", narrativa, "...", "YODA_INTRO_B") 
            ...
            self._display_text_screen("Palavras de um Mestre", narrativa, "Ouvir com atenção...", "YODA_INTRO_C")
            ...
            self._display_text_screen("Sabedoria Ancestral", narrativa, "Estou pronta(o). Iniciar Missão 1", "START_MISSION_DC_1", button_style="Accent.Dark.TButton", image_to_display=self.alianca_simbolo_photo)
        
        # --- FLUXO DAS NOVAS MISSÕES ---
        elif self.game_state == "START_MISSION_DC_1":
            narrativa = ["Missão 1: O Enigma da Mediana (Mediana das Medianas)", "\n(Esta missão ainda está em desenvolvimento.)"]
            self._display_text_screen("MISSÃO 1 EM DESENVOLVIMENTO", narrativa, "Avançar para a Próxima Missão", "MISSION_DC_1_SUCCESS")
            ...
            self._display_text_screen("Análise Concluída", dialogo, "Aguardando ordens.", "START_MISSION_DC_2", button_style="Accent.Dark.TButton", image_to_display=self.alianca_simbolo_photo)
        elif self.game_state == "START_MISSION_DC_2":
            narrativa = ["Missão 2: Dicas do Mestre (Contagem de Inversões)", "\n(Esta missão ainda está em desenvolvimento.)"]
            self._display_text_screen("MISSÃO 2 EM DESENVOLVIMENTO", narrativa, "Avançar para a Próxima Missão", "MISSION_DC_2_SUCCESS")
